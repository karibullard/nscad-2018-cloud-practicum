...
{
	public class WorkflowBlobService : IBlobService
	{
		...
		public Task<List<WorkflowUpload>> UploadBlobs(HttpContent httpContent)
		{
			...
			// TODO: Use data in the list to store blob info in your database so that you can always
			// retrieve it later.
